...
call rmdir /s /q c:\tmp\wms-builds\config-idd
call git clone https://github.com/knpillutla/config-idd.git c:\tmp\wms-builds\config-idd
call cd c:\tmp\wms-builds\config-idd
call mvn clean compile install
POPD